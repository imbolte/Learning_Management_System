...
const Policy = (props: Props) => {
  return (
    <div className="w-[95%] 800px:w-[92%] m-auto py-2 text-charcoal dark:text-white px-3 bg-transparent">
      <br />
      <br />
      <h1 className={`${styles.title} !text-start pt-2`}>
        <span className="text-emerald-500">Privacy Policy</span> - ELearning
      </h1>
      <ul style={{ listStyle: "unset", marginLeft: "15px" }}>
        <p className="py-2 ml-[-15px] text-[16px] font-Poppins leading-8 whitespace-pre-line text-charcoal/80 dark:text-white/90">
